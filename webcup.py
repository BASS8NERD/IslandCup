...
INSECT_CREATURES = [
    {"Creatura": "FARFALLA COMUNE", "Foto": f"{GITHUB_RAW_BASE}/121.png", "Valore": 4},
    {"Creatura": "FARFALLA GIALLA", "Foto": f"{GITHUB_RAW_BASE}/122.png", "Valore": 4},
    {"Creatura": "FARFALLA TIGRE", "Foto": f"{GITHUB_RAW_BASE}/123.png", "Valore": 4},
    {"Creatura": "FARFALLA VANESSA IO", "Foto": f"{GITHUB_RAW_BASE}/124.png", "Valore": 5},
    {"Creatura": "GRAPHIUM SARPEDON", "Foto": f"{GITHUB_RAW_BASE}/125.png", "Valore": 4},
    {"Creatura": "FARFALLA CARTA DI RISO", "Foto": f"{GITHUB_RAW_BASE}/126.png", "Valore": 5},
    {"Creatura": "FARFALLA IMPERATORE VIOLA", "Foto": f"{GITHUB_RAW_BASE}/127.png", "Valore": 5},
    {"Creatura": "FARFALLA MONARCA", "Foto": f"{GITHUB_RAW_BASE}/128.png", "Valore": 4},
    {"Creatura": "FARFALLA MORFO BLU", "Foto": f"{GITHUB_RAW_BASE}/129.png", "Valore": 5},
    {"Creatura": "FARFALLA AGRIAS", "Foto": f"{GITHUB_RAW_BASE}/130.png", "Valore": 5},
    {"Creatura": "FARFALLA RAJA BROOKE", "Foto": f"{GITHUB_RAW_BASE}/131.png", "Valore": 5},
    {"Creatura": "FARFALLA REGINA ALESSANDRA", "Foto": f"{GITHUB_RAW_BASE}/132.png", "Valore": 5},
    {"Creatura": "FALENA", "Foto": f"{GITHUB_RAW_BASE}/133.png", "Valore": 2},
    {"Creatura": "FARFALLA COBRA", "Foto": f"{GITHUB_RAW_BASE}/134.png", "Valore": 6},
    {"Creatura": "URANIA DEL MADAGASCAR", "Foto": f"{GITHUB_RAW_BASE}/135.png", "Valore": 5},
    {"Creatura": "ACRIDA CINEREA", "Foto": f"{GITHUB_RAW_BASE}/136.png", "Valore": 4},
    {"Creatura": "LOCUSTA MIGRATORIA", "Foto": f"{GITHUB_RAW_BASE}/137.png", "Valore": 5},
    {"Creatura": "LOCUSTA", "Foto": f"{GITHUB_RAW_BASE}/138.png", "Valore": 4},
    {"Creatura": "CAVALLETTA", "Foto": f"{GITHUB_RAW_BASE}/139.png", "Valore": 4},
    {"Creatura": "GRILLO", "Foto": f"{GITHUB_RAW_BASE}/140.png", "Valore": 4},
    {"Creatura": "SUZUMUSHI", "Foto": f"{GITHUB_RAW_BASE}/141.png", "Valore": 4},
    {"Creatura": "MANTIDE", "Foto": f"{GITHUB_RAW_BASE}/142.png", "Valore": 2},
    {"Creatura": "MANTIDE ORCHIDEA", "Foto": f"{GITHUB_RAW_BASE}/143.png", "Valore": 3},
    {"Creatura": "APE OPERAIA", "Foto": f"{GITHUB_RAW_BASE}/144.png", "Valore": 4},
    {"Creatura": "VESPA", "Foto": f"{GITHUB_RAW_BASE}/145.png", "Valore": 4},
    {"Creatura": "CICALA MARRONE", "Foto": f"{GITHUB_RAW_BASE}/146.png", "Valore": 5},
    {"Creatura": "CICALA ROBUSTA", "Foto": f"{GITHUB_RAW_BASE}/147.png", "Valore": 5},
    {"Creatura": "CICALA GIGANTE", "Foto": f"{GITHUB_RAW_BASE}/148.png", "Valore": 5},
    {"Creatura": "CICALA SPUTACCHINA", "Foto": f"{GITHUB_RAW_BASE}/149.png", "Valore": 5},
    {"Creatura": "CICALA NOTTURNA", "Foto": f"{GITHUB_RAW_BASE}/150.png", "Valore": 5},
    {"Creatura": "ESUVIA DI CICALA", "Foto": f"{GITHUB_RAW_BASE}/151.png", "Valore": 7},
    {"Creatura": "LIBELLULA ROSSA", "Foto": f"{GITHUB_RAW_BASE}/152.png", "Valore": 4},
    {"Creatura": "LIBELLULA DEPRESSA", "Foto": f"{GITHUB_RAW_BASE}/153.png", "Valore": 4},
    {"Creatura": "LIBELLULA STRIATA", "Foto": f"{GITHUB_RAW_BASE}/154.png", "Valore": 5},
    {"Creatura": "ZIGOTTERO", "Foto": f"{GITHUB_RAW_BASE}/155.png", "Valore": 4},
    {"Creatura": "LUCCIOLA", "Foto": f"{GITHUB_RAW_BASE}/156.png", "Valore": 4},
    {"Creatura": "GRILLOTALPA", "Foto": f"{GITHUB_RAW_BASE}/157.png", "Valore": 3},
    {"Creatura": "GERRIDE", "Foto": f"{GITHUB_RAW_BASE}/158.png", "Valore": 2},
    {"Creatura": "DITISCO", "Foto": f"{GITHUB_RAW_BASE}/159.png", "Valore": 3},
    {"Creatura": "CIMICE D'ACQUA GIGANTE", "Foto": f"{GITHUB_RAW_BASE}/160.png", "Valore": 3},
    {"Creatura": "CIMICE", "Foto": f"{GITHUB_RAW_BASE}/161.png", "Valore": 2},
    {"Creatura": "CATACANTHUS", "Foto": f"{GITHUB_RAW_BASE}/162.png", "Valore": 2},
    {"Creatura": "COCCINELLA", "Foto": f"{GITHUB_RAW_BASE}/163.png", "Valore": 2},
    {"Creatura": "CICINDELA", "Foto": f"{GITHUB_RAW_BASE}/164.png", "Valore": 5},
    {"Creatura": "STIGMODERA", "Foto": f"{GITHUB_RAW_BASE}/165.png", "Valore": 6},
    {"Creatura": "CARABO VIOLINO", "Foto": f"{GITHUB_RAW_BASE}/166.png", "Valore": 6},
    {"Creatura": "TARLO ASIATICO", "Foto": f"{GITHUB_RAW_BASE}/167.png", "Valore": 6},
    {"Creatura": "COLEOTTERO ROSALIA BATESI", "Foto": f"{GITHUB_RAW_BASE}/168.png", "Valore": 7},
    {"Creatura": "COLEOTTERO SCHOENHERR", "Foto": f"{GITHUB_RAW_BASE}/169.png", "Valore": 7},
    {"Creatura": "SCARABEO STERCORARIO", "Foto": f"{GITHUB_RAW_BASE}/170.png", "Valore": 4},
    {"Creatura": "GEOTRUPIDAE", "Foto": f"{GITHUB_RAW_BASE}/171.png", "Valore": 4},
    {"Creatura": "CHRYSINA RESPLENDENS", "Foto": f"{GITHUB_RAW_BASE}/172.png", "Valore": 6},
    {"Creatura": "CETONIA DORATA", "Foto": f"{GITHUB_RAW_BASE}/173.png", "Valore": 5},
    {"Creatura": "SCARABEO GOLIA", "Foto": f"{GITHUB_RAW_BASE}/174.png", "Valore": 6},
    {"Creatura": "COLEOTTERO CERVO", "Foto": f"{GITHUB_RAW_BASE}/175.png", "Valore": 5},
    {"Creatura": "COLEOTTERO LUCANIDE", "Foto": f"{GITHUB_RAW_BASE}/176.png", "Valore": 5},
    {"Creatura": "COLEOTTERO GIGANTE", "Foto": f"{GITHUB_RAW_BASE}/177.png", "Valore": 6},
    {"Creatura": "COLEOTTERO ARCOBALENO", "Foto": f"{GITHUB_RAW_BASE}/178.png", "Valore": 6},
    {"Creatura": "COLEOTTERO CYCLOMMATUS", "Foto": f"{GITHUB_RAW_BASE}/179.png", "Valore": 7},
    {"Creatura": "COLEOTTERO DORATO", "Foto": f"{GITHUB_RAW_BASE}/180.png", "Valore": 7},
    {"Creatura": "COLEOTTERO GIRAFFA", "Foto": f"{GITHUB_RAW_BASE}/181.png", "Valore": 7},
    {"Creatura": "SCARABEO KABUTOMUSHI", "Foto": f"{GITHUB_RAW_BASE}/182.png", "Valore": 5},
    {"Creatura": "SCARABEO ATLAS", "Foto": f"{GITHUB_RAW_BASE}/183.png", "Valore": 7},
    {"Creatura": "SCARABEO ELEFANTE", "Foto": f"{GITHUB_RAW_BASE}/184.png", "Valore": 7},
    {"Creatura": "SCARABEO ERCOLE", "Foto": f"{GITHUB_RAW_BASE}/185.png", "Valore": 7},
    {"Creatura": "INSETTO STECCO", "Foto": f"{GITHUB_RAW_BASE}/186.png", "Valore": 6},
    {"Creatura": "INSETTO FOGLIA", "Foto": f"{GITHUB_RAW_BASE}/187.png", "Valore": 4},
    {"Creatura": "BRUCO DAL FODERO", "Foto": f"{GITHUB_RAW_BASE}/188.png", "Valore": 3},
    {"Creatura": "FORMICA", "Foto": f"{GITHUB_RAW_BASE}/189.png", "Valore": 3},
    {"Creatura": "GRANCHIO PAGURO", "Foto": f"{GITHUB_RAW_BASE}/190.png", "Valore": 3},
    {"Creatura": "LIGIA EXOTICA", "Foto": f"{GITHUB_RAW_BASE}/191.png", "Valore": 2},
    {"Creatura": "MOSCA", "Foto": f"{GITHUB_RAW_BASE}/192.png", "Valore": 3},
    {"Creatura": "ZANZARA", "Foto": f"{GITHUB_RAW_BASE}/193.png", "Valore": 4},
    {"Creatura": "PULCE", "Foto": f"{GITHUB_RAW_BASE}/194.png", "Valore": 3},
    {"Creatura": "CHIOCCIOLA", "Foto": f"{GITHUB_RAW_BASE}/195.png", "Valore": 6},
    {"Creatura": "PORCELLINO DI TERRA", "Foto": f"{GITHUB_RAW_BASE}/196.png", "Valore": 3},
    {"Creatura": "CENTOPIEDI", "Foto": f"{GITHUB_RAW_BASE}/197.png", "Valore": 3},
    {"Creatura": "RAGNO", "Foto": f"{GITHUB_RAW_BASE}/198.png", "Valore": 3},
    {"Creatura": "TARANTOLA", "Foto": f"{GITHUB_RAW_BASE}/199.png", "Valore": 5},
    {"Creatura": "SCORPIONE", "Foto": f"{GITHUB_RAW_BASE}/200.png", "Valore": 5},
]
...
MIX_CREATURES = [
    ...
    {"Creatura": "GRANCIPORRO", "Foto": f"{GITHUB_RAW_BASE}/25.png", "Valore": 6},
    {"Creatura": "GRANCHIO DELLA NEVE", "Foto": f"{GITHUB_RAW_BASE}/20.png", "Valore": 8},
    {"Creatura": "GRANCHIO FERRO DI CAVALLO", "Foto": f"{GITHUB_RAW_BASE}/36.png", "Valore": 5},
    {"Creatura": "GRANCHIO GAZAMI", "Foto": f"{GITHUB_RAW_BASE}/24.png", "Valore": 6},
    {"Creatura": "GRANCHIO GIGANTE", "Foto": f"{GITHUB_RAW_BASE}/27.png", "Valore": 9},
    {"Creatura": "GRANCHIO GIGANTE DEL GIAPPONE", "Foto": f"{GITHUB_RAW_BASE}/29.png", "Valore": 8},
    {"Creatura": "GRANCHIO GUANTATO", "Foto": f"{GITHUB_RAW_BASE}/73.png", "Valore": 3},
    ...
    {"Creatura": "SALMONE", "Foto": f"{GITHUB_RAW_BASE}/71.png", "Valore": 5},
    {"Creatura": "SALMONE GIAPPONESE", "Foto": f"{GITHUB_RAW_BASE}/67.png", "Valore": 5},
    {"Creatura": "SALMON REALE", "Foto": f"{GITHUB_RAW_BASE}/72.png", "Valore": 7},
